...
def run_experiment(config_path: str):
    ...
    if task_type == "classification":
        ...
        evaluator = ClassificationEvaluator(
            n_folds=config["evaluation"]["n_folds"], n_repeats=config["evaluation"]["n_repeats"]
        )
...
def main():
    ...
    parser.add_argument(
        "--config", type=str, default="experiments/configs/default.yaml", help="Path to configuration file"
    )
