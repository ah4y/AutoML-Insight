...
class TestDimRedEvaluator:
    ...
    def test_initialization(self):
        ...
        config_dict = {"dimred": {"enable": "auto", "method": "pca", "variance_target": 0.95}}
        dimred_config = DimRedConfig(config_dict)
        preprocessor = DataPreprocessor()

        evaluator = DimRedEvaluator(preprocessor=preprocessor, dimred_config=dimred_config, random_state=42)
    ...
    def test_evaluate_classification_with_dimred(self):
        ...
        config_dict = {"dimred": {"enable": "off", "method": "pca"}}  # Disable for faster test
        dimred_config = DimRedConfig(config_dict)
        preprocessor = DataPreprocessor()
        ...
        models = {"LogisticRegression": LogisticRegression(random_state=42, max_iter=200)}

        results = evaluator.evaluate_classification_with_dimred(models, X_df, y, task_type="classification")
    ...
    def test_compare_and_select_variant_dimred_better(self):
        ...
        result = evaluator._compare_and_select_variant("TestModel", baseline_results, dimred_results)
    ...
    def test_compare_and_select_variant_baseline_better(self):
        ...
        dimred_results = {"accuracy_mean": 0.75, "accuracy_scores": [0.73, 0.75, 0.76, 0.74, 0.77], "uses_dimred": True}
    ...
    def test_compare_and_select_variant_no_dimred(self):
        ...
        baseline_results = {"accuracy_mean": 0.85, "uses_dimred": False}

        result = evaluator._compare_and_select_variant("TestModel", baseline_results, None)
