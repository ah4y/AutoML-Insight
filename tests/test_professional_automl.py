...
class TestAutoMLPipeline:
    ...
    def test_run_advanced_automl(self, classification_data):
        ...
        results = pipeline.run_advanced_automl(
            X=X,
            y=y,
...
class TestIntegration:
    ...
    def test_end_to_end_classification(self):
        ...
        successful_models = [
            name for name, result in results['individual_models'].items()
            if result.get('best_score', -1000) > 0
        ]
